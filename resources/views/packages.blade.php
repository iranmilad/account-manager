...
@section("toolbar")
<a href="{{route('create-package.show')}}" class="btn btn-primary">پکیج جدید</a>
@endsection
            ...
            <table id="global_table" class="table table-row-bordered gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="p-0 pb-3 min-w-100px text-start">نام پکیج</th>
                        <th class="p-0 pb-3 min-w-100px text-start">قیمت</th>
                        <th class="p-0 pb-3 min-w-100px text-start">دوره زمانی</th>
                        <th class="p-0 pb-3 min-w-100px text-start">کاربران در حال استفاده</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-start">
                            <a href="{{route('edit-package.show',['id'=>1])}}">پکیج ویژه</a>
                        </td>
                        <td class="text-start">2,900,000</td>
                        <td class="text-start">1 ماهه</td>
                        <td class="text-start">50 عدد</td>
                        <td class="text-end">
                            <a href="{{route('edit-package.show',['id'=>1])}}" class="btn btn-light btn-active-light-primary btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
