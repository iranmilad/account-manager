...
@section("toolbar")
<a href="{{route('create-subscribe.show')}}" class="btn btn-primary">مشترک جدید</a>
@endsection
            ...
            <table id="global_table" class="table table-row-bordered gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="p-0 pb-3 min-w-100px text-start">سریال نرم افرار</th>
                        <th class="p-0 pb-3 min-w-100px text-start">تاریخ شروع خرید</th>
                        <th class="p-0 pb-3 min-w-100px text-start">شماره تلفن</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-start">
                            <a href="{{route('edit-subscribe.show',['id'=>1])}}">#123</a>
                        </td>
                        ...
                        <td class="text-end">
                            <a href="{{route('edit-subscribe.show',['id'=>1])}}" class="btn btn-light btn-active-light-primary btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
