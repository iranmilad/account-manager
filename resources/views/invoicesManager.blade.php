...
@section('title', 'مدیریت فاکتور ها')
@section('icon', '/assets/media/icons/computer-monitor.png')
              ...
              <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                <th class="w-10px pe-2">
                  <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#invoices_table1 .form-check-input" value="1" />
                  </div>
                </th>
