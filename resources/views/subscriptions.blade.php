...
@section('icon', '/assets/media/icons/important.png')
...
<div class="card mb-5 mb-xl-10">
	<div class="card-body border-top p-9">
		<div class="notice d-flex bg-light-success rounded border-success border border-dashed p-6 align-items-center">
			<!--begin::Icon-->
			...
			<div>
				...
				<div class="fw-semibold">
					<h4 class="text-gray-900 fw-bold m-0">اشتراک ویژه برای حساب شما فعال شده است</h4>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Wrapper-->
