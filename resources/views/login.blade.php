							...
							<div class="fv-row text-start">
								<div class="row gap-5">
									...
									<div class="fv-row mb-3 mt-3">
										<input autocomplete="off" type="text" name="username" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="نام کاربری">
									...
									<div class="fv-row mb-3">
										<input autocomplete="off" type="text" name="password" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="گذرواژه">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									<!--end::Input=-->
