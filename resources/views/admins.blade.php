...
@section("toolbar")
<a href="{{route('create-admin.show')}}" class="btn btn-primary">ادمین جدید</a>
@endsection
            ...
            <table id="global_table" class="table table-row-bordered gy-5 gs-7">
                <thead>
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        ...
                        <th class="p-0 pb-3 text-start">نام کاربری</th>
                        <th class="p-0 pb-3 text-start">تاریخ ایجاد</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-start">
                            <a href="{{route('edit-admin.show',['id'=>1])}}">admin</a>
                        </td>
                        <td class="text-start">
                            <span dir="ltr">12/12/1403</span>
                        </td>
                        <td class="text-end">
                            <a href="{{route('edit-admin.show',['id'=>1])}}" class="btn btn-light btn-active-light-primary btn-sm">
                                ویرایش
                            </a>
                        </td>
                    </tr>
