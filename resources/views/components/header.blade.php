				                ...
				                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
				                    ...
				                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
				                            ...
				                            <div class="menu-content d-flex align-items-center px-3">
				                                ...
				                                <div class="d-flex flex-column">
				                                    <div class="fw-bold d-flex align-items-center fs-5">فرهاد باقری
				                                        <span class="badge badge-light-warning fw-bold fs-8 px-2 py-1 ms-2">اشتراک ویژه</span>
				                                    </div>
				                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">cfarhad</a>
				                                </div>
				                                <!--end::کاربرname-->
				                            </div>
				                        </div>
				                        ...
				                        <div class="menu-item px-5">
				                            <a href="/profile" class="menu-link px-5">تنظیمات حساب</a>
				                        </div>
				                        <!--end::Menu item-->
				                        <!--begin::Menu item-->
				                        <div class="menu-item px-5">
				                            <a href="../../demo1/dist/account/statements.html" class="menu-link px-5">خرید اشتراک</a>
				                        </div>
				                        <!--end::Menu item-->
				                        <!--begin::Menu separator-->
				                        <div class="separator my-2"></div>
