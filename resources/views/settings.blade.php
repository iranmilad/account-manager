...
@section('icon', '/assets/media/icons/gear.png')
      ...
      <div class="row mb-6">
        ...
        <div class="col-lg-8">
          ...
          <select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-placeholder="انتخاب کنید" data-allow-clear="false">
            ...
            <option value="3">قیمت 3</option>
            <option value="4">قیمت 4</option>
            <option value="5">قیمت 5</option>
            <option value="6">قیمت 6</option>
            <option value="7">قیمت 7</option>
            <option value="8">قیمت 8</option>
            <option value="9">قیمت 9</option>
            <option value="10">قیمت 10</option>
          </select>
          <!--end::Col-->
        </div>
        <!--end::Col-->
      ...
      <div class="row mb-6">
        ...
        <div class="col-lg-8">
          ...
          <select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-placeholder="انتخاب کنید" data-allow-clear="false">
            ...
            <option value="3">موجودی با کسر خورده فروشی</option>
          </select>
          <!--end::Col-->
        </div>
        <!--end::Col-->
      ...
      <div class="row mb-6">
        ...
        <div class="col-lg-8">
          ...
          <select class="form-select form-select-solid" data-control="select2" data-close-on-select="false" data-placeholder="انتخاب کنید" data-allow-clear="false">
            ...
            <option value="3">ثبت پیش فاکتور</option>
            <option value="4">ثبت به عنوان سفارش</option>
          </select>
          <!--end::Col-->
        </div>
        <!--end::Col-->
...
<div class="card mb-5 mb-xl-10">
  <div class="card-header border-0">
    <div class="card-title m-0">
      <h3 class="fw-bold m-0">تنظیمات هزینه ی سفارش</h3>
    </div>
  </div>
  <form class="form">
    <div class="card-body border-top p-9">
      ...
      <div class="row mb-6">
        ...
        <div class="col-lg-8">
          <!--begin::Col-->
          <input type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="وارد کنید" value="" />
          <!--end::Col-->
        </div>
        <!--end::Col-->
      </div>
